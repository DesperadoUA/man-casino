...
<script>
	...
	import app_payment_loop from '~/components/payment-loop/app-payment-loop'
	export default {
		name: "payments",
        components: {app_banner, app_content, app_breadcrumb, app_h1, app_payment_loop},
        data: () => {
			return {
				...
				posts: [
					{thumbnail: '/img/visa.png', permalink: '/payment/visa/'},
					{thumbnail: '/img/visa.png', permalink: '/payment/visa/'},
					{thumbnail: '/img/visa.png', permalink: '/payment/visa/'},
					{thumbnail: '/img/visa.png', permalink: '/payment/visa/'},
					{thumbnail: '/img/visa.png', permalink: '/payment/visa/'},
